...
<body>
  ...
  <main class="content">
  <form enctype="multipart/form-data" action="b_update.php" method="post">
    <center>
      <table border="1">
        <tr>
          <th colspan="2">Banner Table Operation</th>
        </tr>
        <tr>
          <td>Banner Name</td>
          <td><input type="text" name="Banner_name" id="Banner_name" placeholder="Update existing, or leave blank for new"></td>
        </tr>
        <tr>
          <td> New Banner Name</td>
