...
<body>
  ...
  <center><h2>Notify users</h2>
  <a href="./sendemail/index.php"> <input type="submit" value="send email" onclick=" "/></a>
  </center>
  <form action="user_update.php" method="post">
    <center>
      <table border="1">
        <tr>
          <th colspan="2">Table Operation</th>
        </tr>
        <tr>
          <td>Username</td>
      ...
      <input type="submit" value="Delete" name="btndel" onclick="return validateForm('btndel')" />
