...
<div class="navbar">
  ...
  <ul class="navbar-menu">
          <li><a href="../cart/cart.php"><i class="fa-sharp fa-solid fa-cart-shopping"></i>Cart</a></li>
          <li><a href="logout.php"><i class="fa-solid fa-right-from-bracket"></i></i> Logout</a></li>
